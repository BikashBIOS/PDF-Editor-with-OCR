...
import bikash.pdfball.activity.FavouritesActivity;
...
import static bikash.pdfball.util.Constants.ADD_IMAGES;
import static bikash.pdfball.util.Constants.ADD_IMAGES_KEY;
import static bikash.pdfball.util.Constants.ADD_PASSWORD_KEY;
import static bikash.pdfball.util.Constants.ADD_PWD;
import static bikash.pdfball.util.Constants.ADD_TEXT_KEY;
...
import static bikash.pdfball.util.Constants.COMPRESS_PDF;
import static bikash.pdfball.util.Constants.COMPRESS_PDF_KEY;
import static bikash.pdfball.util.Constants.EXCEL_TO_PDF_KEY;
import static bikash.pdfball.util.Constants.EXTRACT_IMAGES;
import static bikash.pdfball.util.Constants.EXTRACT_IMAGES_KEY;
import static bikash.pdfball.util.Constants.EXTRACT_TEXT_KEY;
import static bikash.pdfball.util.Constants.HISTORY_KEY;
import static bikash.pdfball.util.Constants.IMAGE_TO_PDF_KEY;
import static bikash.pdfball.util.Constants.INVERT_PDF_KEY;
import static bikash.pdfball.util.Constants.MERGE_PDF_KEY;
import static bikash.pdfball.util.Constants.PDF_TO_IMAGES;
import static bikash.pdfball.util.Constants.PDF_TO_IMAGES_KEY;
import static bikash.pdfball.util.Constants.QR_BARCODE_KEY;
import static bikash.pdfball.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static bikash.pdfball.util.Constants.REMOVE_PAGES;
import static bikash.pdfball.util.Constants.REMOVE_PAGES_KEY;
import static bikash.pdfball.util.Constants.REMOVE_PASSWORD_KEY;
import static bikash.pdfball.util.Constants.REMOVE_PWd;
import static bikash.pdfball.util.Constants.REORDER_PAGES;
import static bikash.pdfball.util.Constants.REORDER_PAGES_KEY;
import static bikash.pdfball.util.Constants.ROTATE_PAGES;
import static bikash.pdfball.util.Constants.ROTATE_PAGES_KEY;
import static bikash.pdfball.util.Constants.SPLIT_PDF_KEY;
import static bikash.pdfball.util.Constants.TEXT_TO_PDF_KEY;
import static bikash.pdfball.util.Constants.VIEW_FILES_KEY;
import static bikash.pdfball.util.Constants.ZIP_TO_PDF_KEY;
