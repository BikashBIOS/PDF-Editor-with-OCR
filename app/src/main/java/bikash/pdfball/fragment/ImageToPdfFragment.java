...
import bikash.pdfball.activity.CropImageActivity;
import bikash.pdfball.activity.ImageEditor;
import bikash.pdfball.activity.PreviewActivity;
import bikash.pdfball.activity.RearrangeImages;
import bikash.pdfball.adapter.EnhancementOptionsAdapter;
import bikash.pdfball.database.DatabaseHelper;
import bikash.pdfball.interfaces.OnItemClickListener;
import bikash.pdfball.interfaces.OnPDFCreatedInterface;
import bikash.pdfball.model.EnhancementOptionsEntity;
import bikash.pdfball.model.ImageToPDFOptions;
import bikash.pdfball.model.Watermark;
import bikash.pdfball.util.Constants;
import bikash.pdfball.util.CreatePdf;
import bikash.pdfball.util.DialogUtils;
import bikash.pdfball.util.FileUtils;
import bikash.pdfball.util.ImageEnhancementOptionsUtils;
import bikash.pdfball.util.ImageUtils;
import bikash.pdfball.util.MorphButtonUtility;
import bikash.pdfball.util.PageSizeUtils;
import bikash.pdfball.util.PermissionsUtils;
import bikash.pdfball.util.StringUtils;

import static bikash.pdfball.util.Constants.AUTHORITY_APP;
import static bikash.pdfball.util.Constants.DEFAULT_BORDER_WIDTH;
import static bikash.pdfball.util.Constants.DEFAULT_COMPRESSION;
import static bikash.pdfball.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static bikash.pdfball.util.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static bikash.pdfball.util.Constants.DEFAULT_PAGE_COLOR;
import static bikash.pdfball.util.Constants.DEFAULT_PAGE_SIZE;
import static bikash.pdfball.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static bikash.pdfball.util.Constants.DEFAULT_QUALITY_VALUE;
import static bikash.pdfball.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static bikash.pdfball.util.Constants.MASTER_PWD_STRING;
import static bikash.pdfball.util.Constants.OPEN_SELECT_IMAGES;
import static bikash.pdfball.util.Constants.READ_WRITE_CAMERA_PERMISSIONS;
import static bikash.pdfball.util.Constants.RESULT;
import static bikash.pdfball.util.Constants.STORAGE_LOCATION;
import static bikash.pdfball.util.Constants.appName;
import static bikash.pdfball.util.WatermarkUtils.getStyleNameFromFont;
import static bikash.pdfball.util.WatermarkUtils.getStyleValueFromName;
